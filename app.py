...
for center in cluster_centers:
    score = (1 - center[features.index("attendance_rate")]) +             (1 - center[features.index("gpa")] / 4.0) +             (1 - center[features.index("assignment_completion")]) +             (1 - center[features.index("lms_activity")])
...
# Risk reason and study tips generation
